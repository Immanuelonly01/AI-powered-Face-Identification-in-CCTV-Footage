...
import DetectionResults from "./DetectionResults.jsx"; // CRITICAL FIX: Ensure DetectionResults is imported
...
export default function FileUpload() {
    ...
    const handleUploadAndSearch = async (e) => {
        ...
        if (!videoFile || !refImageFile) {
            // Using alert() is forbidden. Using a simple console log instead.
